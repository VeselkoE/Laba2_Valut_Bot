...
# Процедура convertor используется для того чтобы перевести одну валюту в другую с указанным кол-во
# Так же в процедуре convertor используется команда "capitalize()" чтобы введеное значение всегда начиналось записывать с заглавной буквы.
